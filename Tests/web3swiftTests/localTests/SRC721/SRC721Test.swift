...
class SRC721Test: LocalTestCase {
    func testDeploy() async throws {
        let web3 = try await Web3.new(LocalTestCase.url, network: Networks.fromInt(6666666))
        let src721 = SRC721(web3: web3)
        let privateKey = Data(hex: "0x7b281a9ba16001feb62a5929526ef8f69d6550c6acdc3f0579c69199c0b6a010")
        let ret = try await src721.deploy(privateKey: privateKey, name: "Ketty1", symbol: "Ketty1", baseURI: "https://www.test.com", maxSupply: BigUInt("10000"), mintPrice: BigUInt("100000000000000000"))
    ...
    func testSetDescription() async throws {
        ...
        let src721 = SRC721(web3: web3, contractAddr: "0x3f1d0998010f4b800d40864e4a33729d575c4e3a")
        let privateKey = Data(hex: "0x7b281a9ba16001feb62a5929526ef8f69d6550c6acdc3f0579c69199c0b6a010")
        let txid = try await src721.setDescription(privateKey: privateKey, description: "Ketty1 is a nft token for testing")
        print(txid)
        XCTAssertNotEqual(txid, nil)
    }
