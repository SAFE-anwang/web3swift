...
public class Proposal {
    ...
    init(web3: Web3) {
        contract = Safe4Contract(web3: web3, contractAddr: Safe4ContractAddress.ProposalContractAddr, contractABI: Safe4ContractABI.ProposalABI)
    }
}
...
public extension Proposal {
    ...
    func getImmatureBalance() async throws -> BigUInt {
        return try await contract.query("getImmatureBalance", outType: BigUInt.self)
    }
